...
public extension Data {
    ...
    static func compress(size: Int64, bufferSize: Int, provider: Provider, consumer: Consumer) throws -> CRC32 {
            ...
            return try process(operation: COMPRESSION_STREAM_ENCODE, size: size, bufferSize: bufferSize,
    ...
    {
        #if os(macOS) || os(iOS) || os(watchOS) || os(tvOS)
            return try process(operation: COMPRESSION_STREAM_DECODE, size: size, bufferSize: bufferSize,
